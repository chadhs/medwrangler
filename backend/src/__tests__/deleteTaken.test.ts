...
import { handler } from "../functions/deleteTaken";

describe("deleteTaken", () => {
  beforeEach(() => {
    jest.clearAllMocks();
  });

  it("should delete a taken dose successfully", async () => {
    mockSend.mockResolvedValue({});

    const event = createMockEvent(null, { id: "taken-123" }, "DELETE");
